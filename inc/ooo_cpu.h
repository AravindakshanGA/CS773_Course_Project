...
class O3_CPU {
  public:
    ...
    PAGE_TABLE_WALKER PTW{"PTW"}; 
        ...
        /* inclusive caches */
        int LLC_eviction_counter, L1_back_req_counter, L2_back_req_counter, cross_core_evict_counter, alarm_counter;
    #endif
	...
	fetch_resume_cycle = 0;
        ...
        RTS1_tail = 0;
                ...
                L1_back_req_counter = 0;
                L2_back_req_counter = 0;
                LLC_eviction_counter = 0;
